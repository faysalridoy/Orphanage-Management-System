...
<head>
  ...
  *{
  ...
  #userhero{
    height: 100%;
    width: 100%;
    background-image: linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url(./img/userprofile.png);
...
<body>
  ...
  <section id="userhero">
    <div class="form-box">
      <center><h1><font size="5px" color="green">Welcome User</h1></center>
        <br><br>
        <ul>
            <li><a href="addDonation.php" data-after="Add Donation">Add Donation</a></li>
            <br>
            <li><a href="viewOrphan.php" data-after="View Orphan">View Orphan</a></li>
            <br>
            <li><a href="viewDonation.php" data-after="View Donation">View Donation</a></li>
            <br>
            </ul>
    </div>
  </section>
